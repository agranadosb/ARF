...
from arf.constants import (
    RESNET_BLOCKS_ENV_VAR,
    RESNET_BATCH_SIZE_VAR,
    TEST_DATA_VAR,
    VALIDATION_DATA_VAR,
    TRAINING_DATA_VAR,
    RESNET_EPOCHS_VAR,
    RESNET_IMAGE_SIZE_VAR,
)
...
INCEPTION_BATCH_SIZE = int(environment_variables.get("INCEPTION_BATCH_SIZE", "32"))
INCEPTION_EPOCHS = int(environment_variables.get("INCEPTION_EPOCHS", "10"))
INCEPTION_IMAGE_SIZE = int(environment_variables.get("INCEPTION_IMAGE_SIZE", "512"))

VIT_BATCH_SIZE = int(environment_variables.get("VIT_BATCH_SIZE", "32"))
VIT_EPOCHS = int(environment_variables.get("VIT_EPOCHS", "10"))
VIT_IMAGE_SIZE = int(environment_variables.get("VIT_IMAGE_SIZE", "512"))
